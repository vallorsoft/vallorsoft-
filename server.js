...
async function sendInviteEmail(toEmail, kod, pozicio, cegNev, igazgatoNev) {
  ...
  const cegSor = cegNev ? 'A <b style="color:#fff;">' + cegNev + '</b> cég számára' : 'Az Ön számára';

  const htmlBody = '<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;background:#05070b;color:#e9eef5;padding:32px;border-radius:16px;">'
    ...
    + '<p style="color:#8a97a8;margin-bottom:16px;">A <b style="color:#fff;">VallorSoft</b> cégtől kapta ezt az emailt.</p>'
    + '<p style="color:#8a97a8;margin-bottom:24px;">' + cegSor + ' aktiválva lett a hozzáférés <b style="color:#fff;">' + pozicio + '</b> szerepkörben.</p>'
    ...
    + '<div style="font-size:13px;font-weight:700;color:#fff;margin-bottom:12px;">Regisztracio lepései:</div>'
