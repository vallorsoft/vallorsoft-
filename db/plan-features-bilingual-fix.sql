-- db/plan-features-bilingual-fix.sql
-- Visszaállítja a subscription_plans.features kétnyelvű JSONB formátumát.
-- Szükséges, mert a devSavePlanDetails handler korábban String(obj) konverzióval
-- "[object Object]" stringekre írta felül a bilingual objektumokat.
-- Idempotens — mindig a helyes kétnyelvű adatot írja be.
