...
**Legújabb kör (2026-07-22 — Sofőr főoldal mini-statisztika: diurna csempe kivéve (csak Admin/Manager látja); 3 csempe szorosan + ~15%-kal magasabb):** *(részletes kész-lista: `CHANGELOG.md`)*
