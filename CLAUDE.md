...
**Legújabb kör (2026-07-22 — FIX: sofőr mobil-app „telefon-lock után nem működik, csak Kilépés+újralépés" — visibility-alapú session-recovery + 8 órás idle-limit + főoldali auto-refresh):** *(részletes kész-lista: `CHANGELOG.md`)*
