...
**Legújabb kör (2026-07-23 — ÚJ: külön `ai-bon-scan` feature-flag + admin/manager önkiszolgáló BE/KI kapcsoló a Menetlevelek fülön + betanult minták nézet/törlés + sofőr főoldalon a gomb csak ha be van kapcsolva):** *(részletes kész-lista: `CHANGELOG.md`)*
