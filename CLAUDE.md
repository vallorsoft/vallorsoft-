...
**Legújabb kör (2026-07-22 — ÚJ: főoldali „📷 Bon szkennelés" gomb + háttér-feldolgozás + perzisztens elfogadás-várólista):** *(részletes kész-lista: `CHANGELOG.md`)*
...
7. **i18n** — 17 új `sof.dashScanBtn`/`sof.scanQueued`/`sof.rr.*` (RO-alap + HU). Cache-bust `?v=20260722scanq` (sofer.html/js/css + i18n.js). **Szerver-oldal ÉRINTETLEN** (`handlers/receiptScan.js`) → az előző körös 12 Jest zöld; teljes suite **672 Jest zöld** (43 skip valós DB).
