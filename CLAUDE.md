...
**Legújabb kör (2026-07-21 — Menetlevél: tankolás/vásárlás per-tétel DÁTUM (naptár-választós, mai alapérték) → statisztika is per-tétel dátum szerint):** *(részletes kész-lista: `CHANGELOG.md`)*
