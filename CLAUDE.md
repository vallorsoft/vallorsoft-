...
Tesztek zöldek (41 Jest). Deploy-teendő: szerver-restart (a `db/*.sql` migrációk, köztük a `db/default-trailer-and-weight.sql` automatikusan lefutnak) + böngésző hard refresh.

**Legutóbbi kör (vontató↔pótkocsi pár, radar GPS, részrakomány-súly, leadás rate-limit):**
