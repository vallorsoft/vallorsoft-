...
**Legújabb kör (2026-07-28 — Bon-scan: a lefotózott bon a kiolvasás elfogadásáig MEGMARAD (IndexedDB) + 15 mp-es holt idő megszüntetve):** *(részletes kész-lista: `CHANGELOG.md`)*
