...
**Legújabb kör (2026-07-28 — Menetlevél: per-sofőr Plecare/Sosire memoriál + a driver-beírt lerakás auto-Finalizat + LEZÁRT FUVAR bucket a `descarcat_at`-ra is):** *(részletes kész-lista: `CHANGELOG.md`)*
