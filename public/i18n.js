...
(function () {
  var DICT = {
    ...
    // ── Könyvelői felület (/konyvelo) ──
    'kv.subtitle': { hu: 'Könyvelői felület', ro: 'Interfață contabil' },
    'kv.month': { hu: 'Hónap', ro: 'Lună' },
    'kv.orFrom': { hu: 'vagy -tól', ro: 'sau de la' },
    'kv.to': { hu: '-ig', ro: 'până la' },
    'kv.refresh': { hu: 'Frissítés', ro: 'Reîmprospătează' },
    'kv.tabDocs': { hu: '📄 Dokumentumok', ro: '📄 Documente' },
    'kv.tabInv': { hu: '🧾 Számla-export (SAGA/WinMentor)', ro: '🧾 Export facturi (SAGA/WinMentor)' },
    'kv.selectAll': { hu: 'Mind kijelölése', ro: 'Selectează tot' },
    'kv.zipSel': { hu: '⬇️ Kijelöltek letöltése (ZIP)', ro: '⬇️ Descarcă selecția (ZIP)' },
    'kv.zipMonth': { hu: '📦 Teljes időszak letöltése (ZIP)', ro: '📦 Descarcă toată perioada (ZIP)' },
    'kv.invTitle': { hu: '🧾 Számla-export könyvelőnek (SAGA / WinMentor)', ro: '🧾 Export facturi pentru contabil (SAGA / WinMentor)' },
    'kv.invHelp': { hu: 'A választott időszak számláit CSV-ben töltöd le (UTF-8, pontosvessző — Excel/SAGA/WinMentor importálható). A könyvelőnek nem kell kézzel átírnia semmit.', ro: 'Descarci facturile din perioada selectată în CSV (UTF-8, punct și virgulă — importabil în Excel/SAGA/WinMentor). Contabilul nu trebuie să rescrie nimic manual.' },
    'kv.salesTitle': { hu: 'Kimenő számlák (ügyfél)', ro: 'Facturi emise (client)' },
    'kv.purTitle': { hu: 'Bejövő számlák (alvállalkozói)', ro: 'Facturi primite (subcontractant)' },
    'kv.invInPeriod': { hu: 'számla az időszakban', ro: 'facturi în perioadă' },
    'kv.dlSales': { hu: '⬇️ Kimenő számlák CSV', ro: '⬇️ CSV facturi emise' },
    'kv.dlPur': { hu: '⬇️ Bejövő számlák CSV', ro: '⬇️ CSV facturi primite' },
    'kv.loadErrPerm': { hu: 'Betöltési hiba vagy nincs jogosultság.', ro: 'Eroare la încărcare sau lipsă permisiune.' },
    'kv.noDocs': { hu: 'Nincs dokumentum ebben az időszakban.', ro: 'Niciun document în această perioadă.' },
    'kv.otherGroup': { hu: 'Egyéb (fuvar nélkül)', ro: 'Altele (fără cursă)' },
    'kv.docsAbbr': { hu: 'dok.', ro: 'doc.' },
    'kv.selected': { hu: '{n} kijelölve', ro: '{n} selectate' },
    'kv.dlErr': { hu: 'Letöltési hiba', ro: 'Eroare la descărcare' },
    'kv.pickOne': { hu: 'Jelölj ki legalább egy dokumentumot.', ro: 'Selectează cel puțin un document.' },
    'kv.zipMaking': { hu: 'ZIP készítése…', ro: 'Se creează ZIP…' },
    'kv.zipMonthMaking': { hu: 'Teljes időszak ZIP-elése…', ro: 'Se arhivează toată perioada…' },
    // ── Admin/Manager dinamikus toast-üzenetek ──
    'am.loadPdfFirst': { hu: 'Előbb töltsd be a PDF-et!', ro: 'Încarcă mai întâi PDF-ul!' },
    'am.noStamp': { hu: 'Nincs mentett pecsét!', ro: 'Nicio ștampilă salvată!' },
    'am.stampAdded': { hu: 'Pecsét hozzáadva – húzd a helyére', ro: 'Ștampilă adăugată – trage-o la locul ei' },
    'am.burning': { hu: 'Ráégetés folyamatban...', ro: 'Se aplică...' },
    'am.savedToSystem': { hu: 'Mentve a rendszerbe!', ro: 'Salvat în sistem!' },
    'am.driverOrCompanyReq': { hu: 'A sofőr neve vagy a cég neve kötelező!', ro: 'Numele șoferului sau al firmei este obligatoriu!' },
    'am.driverAdded': { hu: 'Sofőr hozzáadva!', ro: 'Șofer adăugat!' },
    'am.code': { hu: '✅ Kód: ', ro: '✅ Cod: ' },
    'am.mapNotLoaded': { hu: 'A térkép nem töltődött be.', ro: 'Harta nu s-a încărcat.' },
    'am.max7Waypoints': { hu: 'Legfeljebb 7 köztespont.', ro: 'Maxim 7 puncte intermediare.' },
    'am.csvEmpty': { hu: 'A CSV üres vagy csak fejléc.', ro: 'CSV-ul este gol sau conține doar antetul.' },
    'am.uploadCsvFirst': { hu: 'Előbb tölts fel egy CSV-t!', ro: 'Încarcă mai întâi un CSV!' },
    'am.importDone': { hu: '📥 Import kész: ', ro: '📥 Import finalizat: ' },
    'am.importErr': { hu: 'Import hiba', ro: 'Eroare la import' },
    'am.clientNameReq': { hu: 'Az ügyfél neve kötelező!', ro: 'Numele clientului este obligatoriu!' },
    'am.pickLoadType': { hu: 'Válaszd ki a rakomány típusát (FTL / LTL)!', ro: 'Alege tipul încărcăturii (FTL / LTL)!' },
    'am.ltlDimsReq': { hu: 'Részrakománynál (LTL) a méretek (hossz/szél./mag.) kötelezők!', ro: 'La grupaj (LTL) dimensiunile (lung./lăț./înălț.) sunt obligatorii!' },
    'am.orderSaved': { hu: 'Fuvar mentve! ID: ', ro: 'Cursă salvată! ID: ' },
    'am.plateReq': { hu: 'A rendszám kötelező!', ro: 'Numărul de înmatriculare este obligatoriu!' },
    'am.deletedX': { hu: 'Törölve!', ro: 'Șters!' },
    'am.deleted': { hu: 'Törölve', ro: 'Șters' },
    'am.driverNotFound': { hu: 'Sofőr nem található', ro: 'Șoferul nu a fost găsit' },
    'am.vehicleNotFound': { hu: 'Jármű nem található', ro: 'Vehiculul nu a fost găsit' },
    'am.loadErr': { hu: 'Betöltési hiba', ro: 'Eroare la încărcare' },
    'am.pickClient': { hu: 'Válassz ügyfelet!', ro: 'Alege un client!' },
    'am.giveContactEmail': { hu: 'Add meg a kapcsolattartó e-mailjét!', ro: 'Introdu e-mailul persoanei de contact!' },
    'am.saveOrderFirst': { hu: 'Előbb mentsd a fuvart.', ro: 'Salvează mai întâi cursa.' },
    'am.twofaOff': { hu: '2FA kikapcsolva.', ro: '2FA dezactivat.' },
    'am.companyNameReq': { hu: 'A cégnév kötelező!', ro: 'Numele firmei este obligatoriu!' },
    'am.pw2Mismatch': { hu: 'A két új jelszó nem egyezik!', ro: 'Cele două parole noi nu coincid!' },
    'am.handoverPlaceReq': { hu: 'A leadás helye (helység) kötelező!', ro: 'Locul predării (localitatea) este obligatoriu!' },
    'am.printErr': { hu: 'A nyomtatás nem indítható el', ro: 'Tipărirea nu poate fi pornită' },
    'am.nameReq': { hu: 'A név kötelező!', ro: 'Numele este obligatoriu!' },
    'am.give6Code': { hu: 'Add meg a 6 jegyű kódot!', ro: 'Introdu codul din 6 cifre!' },
    'am.givePw': { hu: 'Add meg a jelszavadat!', ro: 'Introdu parola!' },
    'am.givePrefix': { hu: 'Add meg a prefixet!', ro: 'Introdu prefixul!' },
    'am.giveValidAmount': { hu: 'Adj meg érvényes összeget!', ro: 'Introdu o sumă validă!' },
    'am.sigAdded': { hu: 'Aláírás hozzáadva – húzd a helyére', ro: 'Semnătură adăugată – trage-o la locul ei' },
    'am.sigSaved': { hu: 'Aláírás mentve!', ro: 'Semnătură salvată!' },
    'am.pwMin6': { hu: 'Az új jelszó legalább 6 karakter legyen!', ro: 'Parola nouă trebuie să aibă minim 6 caractere!' },
    'am.stampSaved': { hu: 'Bélyegző elmentve!', ro: 'Ștampilă salvată!' },
    'am.drawSigFirst': { hu: 'Előbb rajzolj aláírást!', ro: 'Desenează mai întâi o semnătură!' },
    'am.uploadedX': { hu: 'Feltöltve!', ro: 'Încărcat!' },
    'am.payReset': { hu: 'Fizetés visszaállítva (kintlévő)', ro: 'Plată resetată (de încasat)' },
    'am.pwChanged': { hu: 'Jelszó sikeresen módosítva!', ro: 'Parola a fost modificată cu succes!' },
    'am.pickOneOrder': { hu: 'Jelölj ki legalább egy fuvart!', ro: 'Selectează cel puțin o cursă!' },
    'am.connErr': { hu: 'Kapcsolat hiba', ro: 'Eroare de conexiune' },
    'am.reqRejected': { hu: 'Kérés elutasítva', ro: 'Cerere respinsă' },
    'am.saved': { hu: 'Mentve!', ro: 'Salvat!' },
    'am.allFieldsReq': { hu: 'Minden mező kötelező!', ro: 'Toate câmpurile sunt obligatorii!' },
    'am.pdfOpenErr': { hu: 'Nem sikerült megnyitni a PDF-et', ro: 'Nu s-a putut deschide PDF-ul' },
    'am.notFound': { hu: 'Nem található', ro: 'Nu a fost găsit' },
    'am.noSigOrStamp': { hu: 'Nincs elhelyezett aláírás vagy pecsét!', ro: 'Nicio semnătură sau ștampilă plasată!' },
    'am.noOrderSelected': { hu: 'Nincs kiválasztott fuvar!', ro: 'Nicio cursă selectată!' },
    'am.profileSaved': { hu: 'Profil mentve!', ro: 'Profil salvat!' },
    'am.revoked': { hu: 'Visszavonva!', ro: 'Revocat!' },
    'am.pickPdf': { hu: 'Válassz PDF fájlt!', ro: 'Alege un fișier PDF!' },
    'am.pickCarrier': { hu: 'Válassz alvállalkozót!', ro: 'Alege un subcontractant!' },
    'am.swapAdded': { hu: 'Váltás hozzáadva!', ro: 'Schimb adăugat!' },
    'am.twofaOn': { hu: '✅ 2FA sikeresen bekapcsolva!', ro: '✅ 2FA activat cu succes!' },
    'am.downloadedSwaps': { hu: '✅ Letöltve — a váltások kék sorban jelennek meg!', ro: '✅ Descărcat — schimburile apar pe rândul albastru!' },
    'am.waybillSaved': { hu: '✅ Menetlevél mentve!', ro: '✅ Foaie de parcurs salvată!' },
    'am.savedOk': { hu: '✅ Mentve!', ro: '✅ Salvat!' },
    'am.statusOk': { hu: '✅ Státusz: ', ro: '✅ Status: ' },
    'am.seriesSaved': { hu: '✅ Széria elmentve — ', ro: '✅ Serie salvată — ' },
    'am.trackLinkCopied': { hu: '🌍 Követő-link a vágólapon — küldd el az ügyfélnek!', ro: '🌍 Link de urmărire în clipboard — trimite-l clientului!' },
    'am.pairedDriver': { hu: '👤 Párosított sofőr kitöltve: ', ro: '👤 Șofer asociat completat: ' },
    'am.payRecorded': { hu: '💸 Fizetés rögzítve', ro: '💸 Plată înregistrată' },
    'am.carrierSaved': { hu: '🚚 Alvállalkozó mentve', ro: '🚚 Subcontractant salvat' },
    'am.pairedTrailer': { hu: '🚚 Párosított pótkocsi kitöltve: ', ro: '🚚 Remorcă asociată completată: ' },
    'am.pairedVehicle': { hu: '🚛 Párosított jármű kitöltve: ', ro: '🚛 Vehicul asociat completat: ' },
    'am.estimatedToll': { hu: '🛣️ Becsült útdíj: ', ro: '🛣️ Taxă de drum estimată: ' },
    'am.ratesSaved': { hu: '🛣️ Ráták mentve', ro: '🛣️ Tarife salvate' },
    'am.tollEstimating': { hu: '🛣️ Útdíj becslése az útvonalból…', ro: '🛣️ Se estimează taxa de drum din traseu…' },
  };
