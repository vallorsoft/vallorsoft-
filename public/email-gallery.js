...
(function () {
  ...
  window.EB_GALLERY = [
    ...
    { key: 'sunset-hero', accent: '#f6711e',
      ...
      html: wrap('#f4efe9',
        '<tr><td style="background:linear-gradient(135deg,#fb8c3a,#f6517b);padding:46px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'ocean-business', accent: '#2563eb',
      ...
      html: wrap('#eef2f8',
        '<tr><td style="background:#1e3a8a;padding:26px 32px;">{{logo}}'
    ...
    { key: 'forest-confirm', accent: '#16a34a',
      ...
      html: wrap('#eaf6ee',
        '<tr><td style="padding:40px 32px 18px;text-align:center;">{{logo}}'
        ...
        + '<div style="text-align:center;">' + btn('#16a34a', 'Urmărește transportul', '{{track_url}}') + '</div></td></tr>'
    ...
    { key: 'espresso-premium', accent: '#d4a14e',
      ...
      html: '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#15110d;padding:28px 0;margin:0;"><tr><td align="center">'
        ...
        + '<tr><td style="padding:44px 36px 14px;text-align:center;">{{logo}}'
    ...
    { key: 'minimal-clean', accent: '#111827',
      ...
      html: wrap('#ffffff',
        '<tr><td style="padding:48px 40px 0;">{{logo}}'
    ...
    { key: 'coral-promo', accent: '#f6517b',
      ...
      html: wrap('#fdeef3',
        '<tr><td style="background:#f6517b;padding:18px;text-align:center;">{{logo}}'
    ...
    { key: 'teal-newsletter', accent: '#0d9488',
      ...
      html: wrap('#e6f4f2',
        '<tr><td style="background:#0d9488;padding:24px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'purple-creative', accent: '#7c3aed',
      ...
      html: wrap('#f1ecfb',
        '<tr><td style="background:linear-gradient(135deg,#7c3aed,#4f46e5);padding:42px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'amber-reminder', accent: '#d97706',
      ...
      html: wrap('#fdf6e8',
        '<tr><td style="padding:34px 32px 10px;text-align:center;">{{logo}}'
    ...
    { key: 'navy-corporate', accent: '#1e293b',
      ...
      html: wrap('#eef0f3',
        '<tr><td style="padding:36px 40px 0;border-top:6px solid #1e293b;">{{logo}}'
    ...
    { key: 'red-urgent', accent: '#dc2626',
      ...
      html: wrap('#fdeaea',
        '<tr><td style="background:#dc2626;padding:30px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'pastel-thanks', accent: '#db2777',
      ...
      html: wrap('#fbeef5',
        '<tr><td style="padding:46px 36px 12px;text-align:center;">{{logo}}'
    ...
    { key: 'invoice-statement', accent: '#334155',
      ...
      html: wrap('#eef1f5',
        '<tr><td style="background:#334155;padding:24px 32px;">{{logo}}'
    ...
    { key: 'quote-detailed', accent: '#0f766e',
      ...
      html: wrap('#eaf2f0',
        '<tr><td style="background:#0f766e;padding:26px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'corporate-report', accent: '#1d4ed8',
      ...
      html: wrap('#eef2fb',
        '<tr><td style="background:#1e3a8a;padding:24px 32px;">{{logo}}<span style="color:#fff;font-size:19px;font-weight:800;">Raport lunar — {{cegnev}}</span></td></tr>'
    ...
    { key: 'legal-notice', accent: '#475569',
      ...
      html: wrap('#f1f1ef',
        '<tr><td style="padding:34px 40px 0;border-top:5px solid #475569;">{{logo}}'
    ...
    { key: 'corporate-multi', accent: '#0369a1',
      ...
      html: wrap('#eef2f5',
        '<tr><td style="background:#0c4a6e;padding:22px 32px;text-align:center;">{{logo}}<span style="color:#fff;font-size:19px;font-weight:800;">Noutăți {{cegnev}}</span><div style="color:#bae6fd;font-size:12px;margin-top:4px;">{{datum}}</div></td></tr>'
    ...
    { key: 'tracking-status', accent: '#0d9488',
      ...
      html: wrap('#e9f4f2',
        '<tr><td style="background:#0d9488;padding:24px 32px;">{{logo}}<span style="color:#fff;font-size:19px;font-weight:800;">Stadiul transportului</span></td></tr>'
        + '<tr><td style="padding:26px 32px 8px;color:#134e4a;">'
        ...
        + '</table>'
        + '<div style="text-align:center;margin:22px 0 4px;">' + btn('#0d9488', 'Urmărește în timp real', '{{track_url}}') + '</div></td></tr>'
        + footer('#79aaa3', '#0d9488')) },
    ...
    { key: 'price-list', accent: '#b45309',
      ...
      html: wrap('#fbf3e8',
        '<tr><td style="background:#92400e;padding:24px 32px;text-align:center;">{{logo}}<h1 style="margin:0;color:#fff;font-size:21px;font-weight:800;">Lista noastră de servicii</h1></td></tr>'
    ...
    { key: 'appointment', accent: '#4338ca',
      ...
      html: wrap('#eeeefb',
        '<tr><td style="background:#4338ca;padding:26px 32px;text-align:center;">{{logo}}<h1 style="margin:0;color:#fff;font-size:21px;font-weight:800;">Programare confirmată</h1></td></tr>'
    ...
    { key: 'annual-summary', accent: '#0f172a',
      ...
      html: wrap('#eceef2',
        '<tr><td style="background:#0f172a;padding:34px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'neon-dark', accent: '#22d3ee',
      ...
      html: darkWrap('#05060a', '#0b0e17', 'Arial,Helvetica,sans-serif',
        '<tr><td style="padding:44px 34px 10px;text-align:center;border-bottom:1px solid #18203a;">{{logo}}'
    ...
    { key: 'terminal-tech', accent: '#22c55e',
      ...
      html: darkWrap('#000000', '#0a0f0a', "'Courier New',Courier,monospace",
        '<tr><td style="padding:18px 24px;border-bottom:1px solid #16301a;">{{logo}}<span style="color:#22c55e;font-size:13px;">user@{{cegnev}}:~$</span> <span style="color:#7dd3a0;font-size:13px;">./mesaj.sh</span></td></tr>'
    ...
    { key: 'holographic', accent: '#ec4899',
      ...
      html: wrap('#0f0f1a',
        '<tr><td style="background:#7c3aed;background:linear-gradient(120deg,#22d3ee,#a855f7,#ec4899,#f59e0b);padding:48px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'cyberpunk', accent: '#ff2d95',
      ...
      html: darkWrap('#070311', '#0e0820', 'Arial,Helvetica,sans-serif',
        '<tr><td style="padding:40px 32px 12px;text-align:center;border-bottom:1px solid #2a1840;">{{logo}}'
    ...
    { key: 'electric-minimal', accent: '#2f6bff',
      ...
      html: wrap('#f3f6ff',
        ...
        + '<tr><td style="padding:42px 40px 0;">{{logo}}'
    ...
    { key: 'cosmic-space', accent: '#8b5cf6',
      ...
      html: '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0b1026;background:radial-gradient(circle at 30% 20%,#1e1b4b,#0b1026 70%);padding:30px 0;margin:0;"><tr><td align="center">'
        ...
        + '<tr><td style="padding:48px 36px 14px;text-align:center;">{{logo}}'
    ...
    { key: 'soft-modern', accent: '#6366f1',
      ...
      html: wrap('#eef0fb',
        '<tr><td style="background:#e0e7ff;background:linear-gradient(135deg,#e0e7ff,#fae8ff);padding:40px 32px;text-align:center;">{{logo}}'
    ...
    { key: 'gradient-mesh', accent: '#f97316',
      ...
      html: wrap('#fdeee4',
        '<tr><td style="background:#f97316;background:linear-gradient(115deg,#f97316,#ec4899,#8b5cf6);padding:46px 32px;text-align:center;">{{logo}}'
