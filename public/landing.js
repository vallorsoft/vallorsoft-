...
const translations = {
  ro: {
    ...
    sfWeek: {
      ...
      footer: ['4 zile diurnă extern + 3 intern', '1 240 km', '1 click PDF'],
    },
    ...
    t1Name: 'Popescu Andrei', t1Company: 'Trans SRL',
    t2Name: 'Kovács László', t2Company: 'SpeedTrans Kft.',
    t3Name: 'Muresan Ioan', t3Company: 'LogiNext SRL',
  ...
  hu: {
    ...
    sfWeek: {
      ...
      footer: ['4 nap diurna extern + 3 intern', '1 240 km', '1 kattintás PDF'],
    },
