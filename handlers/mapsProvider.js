...
const { clearConfigCache } = require('../lib/mapsProvider');
...
// mapsGetProvider / mapsSaveProvider / mapsTestProvider törölve:
// legacy admin-oldali handlerek voltak, de nincs rájuk UI (a cég-admin
// Integrációk fülén ez már nincs; a térkép-szolgáltatót a developer állítja
// cégenként a devGetCompanyIntegrations / devSaveCompanyMaps handlereken át).
