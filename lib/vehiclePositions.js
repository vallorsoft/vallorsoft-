...
async function getReadingsForPlate(cid, plate) {
  ...
  if (mileage == null && fuel_level == null && battery_voltage == null) return { ok: true, available: false };
  return { ok: true, available: true, mileage, fuel_level, battery_voltage, datetime: st.datetime || null };
}
